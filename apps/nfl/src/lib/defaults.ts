...
// (T-79 anchor). T-minus values carry seconds (e.g. ROUTES ON AIR at T-37:30);
// clock times are always calculated from kickoff, never stored. The anchor can
// be shifted as a whole in the Schedule Editor (T-77 / T-79 / T-80 / custom).
